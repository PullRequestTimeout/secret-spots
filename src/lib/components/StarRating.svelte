<script>
	...
	function setRating(value) {
		rating = value;
		updateStarRating($activeSpot, value);
	}
	...
	function updateStarRating(spotName, rating) {
		userSpots.update((spotList) => {
			// Find the spot with the activeSpot store value and update the starRating value
